  ...
  return (
    <Container data-aos="fade-up">
      <div className="mx-auto max-w-6xl">
        {/* User Info Header */}
        <div className="mb-2 mt-6 flex items-center justify-between rounded-2xl border border-neutral-200/60 bg-white/60 px-6 py-4 backdrop-blur-sm dark:border-neutral-700/60 dark:bg-neutral-900/60">
          <div className="flex items-center gap-3">
            <div className="h-8 w-8 overflow-hidden rounded-full border-2 border-blue-200 dark:border-blue-800">
              {session?.user?.image ? (
                <img
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={clearChat}
              className="rounded-xl bg-orange-100 px-3 py-2 text-sm font-medium text-orange-600 transition-colors hover:bg-orange-200 dark:bg-orange-900/20 dark:text-orange-400 dark:hover:bg-orange-900/30"
              title={locale === "id" ? "Xóa cuộc trò chuyện" : "Clear Chat"}
            >
              <BiTrash size={16} className="mr-1 inline" />
              {locale === "id" ? "Xóa" : "Clear"}
            </button>
            <div className="rounded-xl bg-blue-100 px-3 py-2 text-sm font-medium text-blue-600 dark:bg-blue-900/30 dark:text-blue-400">
              {locale === "id" ? "Auto-saved" : "Auto-saved"}
            </div>
            <button
              onClick={() => signOut()}
              className="rounded-xl bg-red-50 px-4 py-2 text-sm font-medium text-red-600 transition-colors hover:bg-red-100 dark:bg-red-900/20 dark:text-red-400 dark:hover:bg-red-900/30"
            >
        ...
        <div className="relative">
          ...
          {/* Chat Container */}
          <div className="relative h-[700px] overflow-hidden rounded-3xl  bg-white/40    backdrop-blur-xl dark:border-neutral-700/60 dark:bg-neutral-900/60">
            {/* Header */}
            <div className="border-b border-neutral-200/60 bg-white/80 p-6 dark:border-neutral-700/60 dark:bg-neutral-900/60">
              <div className="flex items-center justify-between">
                ...
                <div className="rounded-xl bg-green-100 px-3 py-1 text-xs font-medium text-green-700 dark:bg-green-900/30 dark:text-green-400">
            ...
            <div className="flex h-full flex-col">
              <div className="flex-1 space-y-6 overflow-y-auto p-6">
                ...
                {!isLoadingHistory &&
                  messages.map((message, index) => (
                    ...
                    >
                      ...
                      >
                        <div
                          className={`relative overflow-hidden rounded-3xl px-6 py-4 shadow-lg ${
                            message.role === "user"
                              ? "bg-gradient-to-br from-blue-500 to-blue-600 text-white"
                ...
                {isLoading && (
                  <div className="flex items-start gap-4">
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-purple-100 to-indigo-100 text-purple-600 shadow-lg dark:from-purple-900/30 dark:to-indigo-900/30 dark:text-purple-400">
                      <HiSparkles size={18} className="animate-pulse" />
                    </div>
                    <div className="relative max-w-[75%]">
                      <div className="overflow-hidden rounded-3xl border border-neutral-200/60 bg-white/60 px-6 py-4 shadow-lg dark:border-neutral-700/60 dark:bg-neutral-800/90">
              ...
              {/* Input Area */}
              <div className="border-t border-neutral-200/60 bg-gradient-to-r from-white/50 to-white/80 p-6 dark:border-neutral-700/60 dark:from-neutral-900/50 dark:to-neutral-900/80">
                <div className="relative">
                  <div className="flex items-end gap-3">
                    <div className="relative flex-1">
                      ...
                      {/* Character count */}
                      <div className="absolute bottom-2 right-14 text-xs text-neutral-400">
                        {inputMessage.length}
                      </div>
                    </div>
                    ...
                    <button
                      ...
                      className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500 to-purple-600 text-white shadow-lg transition-all duration-200 hover:scale-105 hover:shadow-xl disabled:from-neutral-300 disabled:to-neutral-400 disabled:text-neutral-500 disabled:hover:scale-100 dark:disabled:from-neutral-700 dark:disabled:to-neutral-600"
                    >
                      {isLoading ? (
